            ...
            <div style={{float:'left',width:"100%"}}>
                ...
                <div style={{display:'inline-block',width:'100%'}}>
                    <div style={{marginRight:'200px',float: 'left'}}>
                        ...
                        <FormTextBoxCtrl label="First Name" onChangeText={onChangeTextHandle} title="NextofKinFirstName" value={details && details.NextofKinFirstName} onlyText={true} disableCtrl={disableControls} isMandatory={true} enableRedBorder={enableRedBorder && (!details.NextofKinFirstName || details.NextofKinFirstName === "")}/><br/>
                        <FormTextBoxCtrl label="Last Name" onChangeText={onChangeTextHandle} title="NextofKinLastName" value={details && details.NextofKinLastName} onlyText={true} disableCtrl={disableControls} isMandatory={true} enableRedBorder={enableRedBorder && (!details.NextofKinLastName || details.NextofKinLastName === "")}/><br/>
                        ...
                        <FormTextBoxCtrl label="Address Line 1" onChangeText={onChangeTextHandle} title="NextofKinAddressLine1" value={details && details.NextofKinAddressLine1} disableCtrl={disableControls} isMandatory={true} enableRedBorder={enableRedBorder && (!details.NextofKinAddressLine1 || details.NextofKinAddressLine1 === "")}/><br/>
                        <FormTextBoxCtrl label="Address Line 2" onChangeText={onChangeTextHandle} title="NextofKinAddressLine2" value={details && details.NextofKinAddressLine2} disableCtrl={disableControls} isMandatory={true} enableRedBorder={enableRedBorder && (!details.NextofKinAddressLine2 || details.NextofKinAddressLine2 === "")}/><br/>
                        <FormTextBoxCtrl label="Address Line 3" onChangeText={onChangeTextHandle} title="NextofKinAddressLine3" value={details && details.NextofKinAddressLine3} disableCtrl={disableControls} isMandatory={true} enableRedBorder={enableRedBorder && (!details.NextofKinAddressLine3 || details.NextofKinAddressLine3 === "")}/><br/>
                        <FormTextBoxCtrl label="Address Line 4" onChangeText={onChangeTextHandle} title="NextofKinAddressLine4" value={details && details.NextofKinAddressLine4} disableCtrl={disableControls} isMandatory={true} enableRedBorder={enableRedBorder && (!details.NextofKinAddressLine4 || details.NextofKinAddressLine4 === "")}/><br/>
